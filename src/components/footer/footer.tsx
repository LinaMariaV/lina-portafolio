export default  function Footer (){
    return(
      ...
      <footer id="footer" className="flex items-center justify-between text-white-600 mt-16 w-full fixed bottom-0">
        <div className="absolute left-5 bottom-5 flex flex-col items-center space-y-4">
          <a
          ...
          <a
            href="https://www.instagram.com/linamvillalba/"
